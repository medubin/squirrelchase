...
/***/ function(module, exports, __webpack_require__) {
	...
	deadSquirrelSprite.src = "/assets/squirrel_dead.png";
	squirrelSprite.src = "/assets/squirrel_sprites.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	dogSprite.src = "/assets/dog_sprites" + Math.floor(Math.random() * (3)) + ".gif";
...
/***/ function(module, exports, __webpack_require__) {
	...
	acornImage.src = "/assets/acorn.gif";
...
/***/ function(module, exports, __webpack_require__) {
	...
	GameView.prototype.renderLose = function () {
	  ...
	  var gameOverLoop = setInterval(function() {
	    ...
	    if (this.game.points <= 6){
	      ...
	      this.ctx.fillText('Press enter to restart', this.game.dimX / 5, this.game.dimY / 2 - 50);
	...
	GameView.prototype.postScore = function(name, callback) {
	  $.ajax({
	      url: 'api/highscores',
	      dataType: 'json',
	      method: 'post',
	      data: {highscore: {name: name, score: this.game.points}},
	      success: callback
	    });
	};
...
/***/ }
/******/ ]);
//# sourceMappingURL=squirrelchase.js.map